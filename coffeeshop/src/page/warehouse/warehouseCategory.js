                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                          {data.map((category, index) => (
                              <tr key={index} className="border-b">
                                  ...
                                  <td className="px-6 py-4 text-md text-gray-500">{category.groupName}</td>
                                  <td className="px-6 py-4 text-md text-gray-500">{category.categoryName}</td>
                                  <td className="px-6 py-4 text-md text-gray-500">{category.des}</td>
                                  <td className="px-6 py-4 text-md font-medium flex">
                                      <button className="bg-brown-500 text-white py-1 px-3 rounded-lg mr-2" onClick={() => handleEdit(category)}>
