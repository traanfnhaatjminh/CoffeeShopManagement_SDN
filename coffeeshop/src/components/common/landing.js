      ...
      <main className="flex flex-col md:flex-row justify-between items-center px-32 ">
        <div className="max-w-lg">
          ...
          <div className="flex space-x-4">
            <button className="px-6 py-3 bg-white text-gray-800 border border-gray-500 hover:bg-gray-200 rounded-full font-lauren">Sign Up For A Trial</button>
            <button className="px-6 py-3 bg-gray-800 text-white hover:bg-gray-700 rounded-full font-lauren">Sign In</button>
          </div>
        </div>
